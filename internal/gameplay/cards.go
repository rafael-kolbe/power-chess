...
func InitialCardCatalog() []CardDefinition {
	return []CardDefinition{
		...
		{ID: "energy-gain", Name: "Energy Gain", Type: CardTypePower, Description: "Gain 4 mana.", Cost: 0, Ignition: 1, Cooldown: 2, Example: "1. You have currently 2 mana.\n2. You activate \"Energy Gain\".\n3. Ignition succeeds the next turn.\n4. You gain 4 mana.", Limit: DefaultCardLimit},
		...
		{ID: "rook-touch", Name: "Rook Touch", Type: CardTypePower, Description: "Give any piece you control, except the king or a rook, the ability to move as if it were a rook for one turn.", Cost: 3, Ignition: 0, Cooldown: 2, Example: "1. You have a knight on b2.\n2. You activate \"Rook Touch\".\n3. You move the knight to b7.", Limit: DefaultCardLimit},
		{ID: "bishop-touch", Name: "Bishop Touch", Type: CardTypePower, Description: "Give any piece you control, except the king or a bishop, the ability to move as if it were a bishop for one turn.", Cost: 3, Ignition: 0, Cooldown: 2, Example: "1. You have a rook on b2.\n2. You activate \"Bishop Touch\".\n3. You move the rook to c3.", Limit: DefaultCardLimit},
		{ID: "retaliate", Name: "Retaliate", Type: CardTypeRetribution, Description: "Target a card on your opponent's cooldown slot, burn x mana from your opponent, x being the mana cost of the targeted card, and if you do, activate that card (in your ignition slot) for yourself.", Cost: 2, Ignition: 0, Cooldown: 9, Example: "1. Opponent has a \"Knight Touch\" on their cooldown slots.\n2. Opponent activates any \"Power\" card.\n3. You activate \"Retaliate\" as retribution.\n4. You target the opponent's \"Knight Touch\", burning 3 mana from your opponent successfully.\n5. You then activate the \"Knight Touch\" for yourself, buffing your rook on a1.\n6. On your next turn you move the rook on a1 to c2.", Limit: DefaultCardLimit},
		{ID: "counterattack", Name: "Counterattack", Type: CardTypeCounter, Description: "If a piece you control would be captured by a piece buffed by a \"Power\" card this turn, capture the attacking piece instead.", Cost: 1, Ignition: 0, Cooldown: 6, Example: "1. Opponent activates \"Rook Touch\" on his pawn on e4.\n2. Your opponent attempts to capture your queen on e6.\n3. You activate \"Counterattack\".\n4. The attacking pawn is captured instead.", Limit: DefaultCardLimit},
		{ID: "blockade", Name: "Blockade", Type: CardTypeCounter, Description: "If a piece you control would be captured by the activation of a \"Counter\" card this turn while attacking, negate the effect of the \"Counter\" card, then return the attacking piece to its original position and choose another piece to move this turn.", Cost: 0, Ignition: 0, Cooldown: 3, Example: "1. You move your pawn on e4 that was buffed by \"Rook Touch\" to e6 in an attempt to capture the opponent's queen.\n2. Opponent activates \"Counterattack\" on your pawn.\n3. You activate \"Blockade\".\n4. The effect of \"Counterattack\" is negated and your pawn stays on e4.\n5. You choose another piece to move this turn.", Limit: DefaultCardLimit},
		{ID: "backstab", Name: "Backstab", Type: CardTypePower, Description: "Target a pawn you control and is currently facing an opponent's piece with an empty square behind it, jump over the piece and capture it, and if you do, gain 3 mana.", Cost: 1, Ignition: 1, Cooldown: 7, Example: "1. You activate \"Backstab\".\n2. Ignition succeeds the next turn.\n3. You have a pawn on e4.\n4. Opponent has a knight on e5 with an empty square behind it.\n5. The pawn on e4 jumps over the knight on e5 to e6 and captures it.\n6. You gain 3 mana.", Limit: DefaultCardLimit},
		...
		{ID: "thunderstorm", Name: "Thunderstorm", Type: CardTypePower, Description: "Randomly choose 10 squares on the board, for each piece you control that is on one of the chosen squares, gain 2 mana, but they cannot move this turn, for each piece your opponent controls that is on one of the chosen squares, burn 2 mana from your opponent, and they cannot move their next turn.", Cost: 10, Ignition: 1, Cooldown: 10, Example: "1. You activate \"Thunderstorm\".\n2. Ignition succeeds the next turn.\n3. You randomly choose 10 squares on the board.\n4. 3 pieces you control are hit, you gain 6 mana and they cannot move this turn.\n5. 4 pieces your opponent controls are hit, you burn 8 mana from your opponent and those pieces cannot move their next turn.", Limit: DefaultCardLimit},
