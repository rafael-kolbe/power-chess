...
func InitialCardCatalog() []CardDefinition {
	return []CardDefinition{
		...
		{ID: "mana-burn", Name: "Mana Burn", Type: CardTypeRetribution, Description: "Burn x mana from your opponent. x is the mana cost of the card in your opponent's ignition slot. If your opponent doesn't have enough mana, the excess is burned from their energized mana pool.", Cost: 1, Ignition: 0, Cooldown: 3, Example: "1. Opponent activates \"Knight Touch\" (cost: 3).\n2. You activate \"Mana Burn\" as retribution.\n3. Opponent has 2 mana: 2 mana is burned from their mana pool, 1 from their energized mana pool.", Limit: DefaultCardLimit},
		...
		{ID: "piece-swap", Name: "Piece Swap", Type: CardTypePower, Description: "Swap positions of one piece you control with one piece your opponent controls up to 2 squares apart, except the king.", Cost: 6, Ignition: 0, Cooldown: 6, Targets: 2, Example: "1. You control a pawn on a3.\n2. You activate \"Piece Swap\".\n3. Your opponent controls a rook on a1.\n4. You swap the pawn on a3 with the rook on a1.\n5. The pawn on a3 is now on a1 and the rook on a1 is now on a3.\n6. The pawn now on a1 can promote.", Limit: DefaultCardLimit},
		{ID: "mind-control", Name: "Mind Control", Type: CardTypePower, Description: "Target a piece your opponent controls, except the king or a queen, and take control of it for three turns.", Cost: 7, Ignition: 2, Cooldown: 10, Targets: 1, EffectDuration: 3, Example: "1. You activate \"Mind Control\".\n2. Ignition succeeds 2 turns later.\n3. Opponent controls a rook on a1.\n4. You take control of the rook on a1 for 3 turns.", Limit: DefaultCardLimit},
		{ID: "zip-line", Name: "Zip Line", Type: CardTypePower, Description: "Target a piece you control, except the king, move it to an empty square in the same row. This will use the turn movement.", Cost: 4, Ignition: 0, Cooldown: 4, Targets: 1, EffectDuration: 0, Example: "1. You control a bishop on b2.\n2. You activate \"Zip Line\".\n3. The bishop on b2 moves to g2.", Limit: DefaultCardLimit},
		{ID: "sacrifice-of-the-masses", Name: "Sacrifice of the Masses", Type: CardTypePower, Description: "Target a pawn you control, sacrifice it to gain 6 mana and draw 2 cards.", Cost: 0, Ignition: 0, Cooldown: 10, Targets: 1, Example: "1. You control a pawn on a3.\n2. You activate \"Sacrifice of the Masses\".\n3. The pawn on a3 is sacrificed and you gain 6 mana and draw 2 cards.", Limit: DefaultCardLimit},
		...
		{ID: "retaliate", Name: "Retaliate", Type: CardTypeRetribution, Description: "Target a card on your opponent's cooldown slot, burn x mana from your opponent, where x is the mana cost of the targeted card, and if you do, activate that card (in your ignition slot) for yourself.", Cost: 2, Ignition: 0, Cooldown: 9, Example: "1. Opponent has a \"Knight Touch\" on their cooldown slot.\n2. Opponent activates any \"Power\" card.\n3. You activate \"Retaliate\" as retribution.\n4. You target the opponent's \"Knight Touch\", burning 3 mana from your opponent successfully.\n5. You then activate the \"Knight Touch\" for yourself, buffing your rook on a1.\n6. On your next turn you move the rook on a1 to c2.", Limit: DefaultCardLimit},
